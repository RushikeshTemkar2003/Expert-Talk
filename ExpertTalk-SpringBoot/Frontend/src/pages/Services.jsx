    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">Our Services</h1>
        ...
        <div className="bg-blue-600 rounded-xl p-6 sm:p-8 text-center text-white">
          <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">Ready to Get Expert Advice?</h2>
          <p className="text-lg sm:text-xl mb-4 sm:mb-6">Join thousands of satisfied customers who trust our platform</p>
          <button className="bg-white text-blue-600 px-6 sm:px-8 py-2 sm:py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-sm sm:text-base">
            Get Started Today
          </button>
        </div>
      </div>
