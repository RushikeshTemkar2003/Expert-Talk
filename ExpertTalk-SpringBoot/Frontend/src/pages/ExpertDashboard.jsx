        ...
        <div className="bg-white rounded-xl shadow-sm mb-6 lg:mb-8">
          <div className="flex border-b overflow-x-auto">
            <button
              ...
              className={`px-4 sm:px-6 py-3 sm:py-4 font-medium text-sm whitespace-nowrap ${activeTab === 'sessions' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-600 hover:text-gray-900'}`}
            >
              💬 My Chats
            </button>
          </div>
          ...
          {loading ? (
            ...
            <div className="space-y-3 sm:space-y-4">
              {sessions.map((session) => (
                <div key={session.id} className="border rounded-lg p-3 sm:p-4 hover:shadow-md transition-shadow">
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-400 rounded-full flex items-center justify-center text-white font-semibold mr-3 text-sm flex-shrink-0">
                    ...
                    {session.lastMessage && (
                      <p className="text-gray-600 text-xs sm:text-sm bg-gray-50 p-2 sm:p-3 rounded line-clamp-2">
                        "{session.lastMessage}"
                      </p>
                    )}
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                      ...
                      <button
                        ...
                        className="w-full sm:w-auto px-3 sm:px-4 py-2 rounded-lg font-medium text-xs sm:text-sm bg-blue-600 text-white hover:bg-blue-700"
                      >
